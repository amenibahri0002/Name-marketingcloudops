...
// ============================================================
async function sendInscriptionConfirmationEmail(userEmail, userName, campagneDetails) {
  try {
...
// ============================================================
async function sendRappelEmail(userEmail, userName, campagneDetails, daysBefore) {
  try {
    const info = await transporter.sendMail({
      from: '"DigiLab Solutions" <contact@digilab.tn>',
      to: userEmail,
